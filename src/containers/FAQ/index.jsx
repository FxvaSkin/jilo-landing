...
const cards = [
  ...
  },
  {
    ...
    body:
      'Полное или частичное погашение может сделать любой человек старше 18 лет, а вот залоговое обеспечение может получить заёмщик или его доверенное лицо, на которого оставлена доверенность.',
  },
  {
    key: 'percent',
